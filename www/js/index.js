/* 	
	...
	try{
		window.addEventListener("deviceorientation",
			function onSuccess(heading)
			{
				document.getElementById('needle').style.transform = 'rotateZ('+parseInt(heading.alpha)+'deg) translateX(0px)';
				document.getElementById('needle').style.webkitTransform  = 'rotateZ('+parseInt(heading.alpha)+'deg) translateX(0px)';
				document.getElementById('circle').style.transform = 'rotateZ('+parseInt(heading.alpha)+'deg) translateX(0px)';
				document.getElementById('circle').style.webkitTransform  = 'rotateZ('+parseInt(heading.alpha)+'deg) translateX(0px)';
			},
		true);
	}
	catch(e){
